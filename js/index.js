...
var ReadStream, S_IFDIR, S_IFLNK, S_IFMT, S_IFREG, WriteStream, defer, errno, follow, fs, getMode, lstat, mkdir, os, path, readFile, readdir, readlink, resolve, stream, uhoh, writeFile;
...
fs.exists = async function(name) {
  return ((await getMode(resolve(name)))) !== void 0;
};
